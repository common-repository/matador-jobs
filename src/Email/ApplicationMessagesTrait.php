...
trait ApplicationMessagesTrait {
	...
	public static function template_args( array $application = [] ) {
		...
		$args = [
			'firstname'       => ! empty( $application['name']['firstName'] ) ? $application['name']['firstName'] : '', // @since 3.6.0
			'lastname'        => ! empty( $application['name']['lastName'] ) ? $application['name']['lastName'] : '', // @since 3.6.0
			...
			'wpid'            => ! empty( $application['wpid'] ) ? $application['wpid'] : '', // @since 3.8.0
			'bhid'            => ! empty( $application['bhid'] ) ? $application['bhid'] : '', // @since 3.8.0
			'candidate_link'  => ! empty( $application['candidate_link'] ) ? $application['candidate_link'] : '', // @since 3.8.0
		 ...
		 * @return array
		 */
		return apply_filters( 'matador_email_application_notifications_template_args', $args );
	}
	...
	public static function attachments( array $application = [] ) {
		...
		/**
		 * Filter: Matador Email Application Notifications Include Attachments
		 *
		 * @since 3.7.0
		 *
		 * @var array $args
		 ...
		 * @return array
		 */
		if ( ! apply_filters( 'matador_email_application_notifications_include_attachments', true ) ) {
